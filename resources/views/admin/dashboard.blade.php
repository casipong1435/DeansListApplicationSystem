...
<div class="d-flex" id="wrapper">
    <div class="sb-color position-relative" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush ">
            ...
            <a href="{{ route('AdminHome')}}" class="list-group-item py-3 list-group-item-action second-text {{ Route::currentRouteName() == 'AdminHome' ? 'current' : '' }}">
                <i class="bi bi-house-fill mx-2"></i>Home
            </a>
            <a href="{{ route('AdminAccount')}}" class="list-group-item py-3 list-group-item-action second-text {{ Route::currentRouteName() == 'AdminAccount' ? 'current' : '' }}">
                <i class="bi bi-people-fill mx-2"></i>Users
            </a>
            <a href="{{route('AdminPrograms')}}" class="list-group-item py-3 list-group-item-action second-text {{ Route::currentRouteName() == 'AdminPrograms' ? 'current' : '' }}">
                <i class="bi bi-list-check mx-2"></i>Institute & Programs
            </a>
    ...
    <div id="page-content-wrapper">
        <nav class="navbar navbar-expand-lg py-2 px-4" id="navbar-top">
            <div class="d-flex align-items-center text-white">
                ...
                <h4 class="text-dark mt-2">Administrator</h4>
            </div>
