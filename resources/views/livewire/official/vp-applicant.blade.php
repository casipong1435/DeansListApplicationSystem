    ...
    <div class="col-lg-12 p-2 ">
        ...
        <div class="row mb-2 p-3">
            <div class="d-flex justify-content-md-between p-2">
                ...
                <div class="d-block">
                    <select class="p-2 mx-2" wire:model.live="office">
                    ...
                    <select class="p-2 mx-2" wire:model="program">
                ...
                <table class="border-0" cellpadding="8">
                    ...
                    <tbody>
                        @if ($semester_status != 0)
                            @if (count($applicants_need_vp) > 0)
                            @php
                                $i = 1;
                            @endphp
                                @foreach ($applicants_need_vp as $applicant)
            ...
            <div class="p-2">
                <strong>Total: </strong>
                <span>{{count($applicants_need_vp)}}</span>
            </div>
